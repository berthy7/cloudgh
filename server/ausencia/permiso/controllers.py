...
class PermisoController(CrudController):

    manager = PermisoManager
    html_index = "ausencia/permiso/views/index.html"
    html_table = "ausencia/permiso/views/table.html"
    routes = {
        '/permiso': {'GET': 'index', 'POST': 'table'},
        '/permiso_insert': {'POST': 'insert'},
        '/permiso_update': {'PUT': 'edit', 'POST': 'update'},
        '/permiso_delete': {'POST': 'delete'},
        '/permiso_disponible': {'POST': 'disponible'},
        '/permiso_autorizacion': {'PUT': 'edit', 'POST': 'autorizacion'},
        '/permiso_aprobacion': {'PUT': 'edit', 'POST': 'aprobacion'},
        '/permiso_imprimir': {'POST': 'imprimir'},
        '/permiso_imprimir_general': {'POST': 'imprimir_general'}
    }

    def get_extra_data(self):
        aux = super().get_extra_data()
        aux['permisos'] = PermisoManager(self.db).listar_todo()
    ...
    def imprimir_general(self):
        ...
        html = "" \
            ...
            "   @page {size: letter portrait; margin: 1cm; @frame footer_frame {-pdf-frame-content: footer_content; left: 50pt; width: 700pt; top: 300pt; height: 20pt; }}" \
            "</style>" \
        ...
        html += "" \
            ...
            "       <td colspan='8' class='text-normal' align='left' style='padding-top: 2px'>... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...</td>" \
            "   </tr>" \
            "   <tr style='font-size: 12px; border: 0px; padding: 0px'>" \
            ...
            "       <td width='30%' colspan='4' align='left' ><font size=4><i class='format'></i></br> </br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;______________________ </br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; JEFE INMEDIATO SUPERIOR</br>&nbsp;&nbsp;&nbsp;&nbsp;</br>&nbsp;&nbsp;&nbsp;&nbsp;______________________ </br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; NOMBRE</br></font></td>"\
            "   </tr>" \
            "   </table>"\
            "   </br>"
        ...
        nombre = "Autorizacion-salida.pdf"
    ...
    def imprimir(self):
        ...
        html += "" \
            ...
            "   <tr style='font-size: 12px; border: 0px; padding: 0px'>" \
            "       <th colspan='3' scope='colgroup' align='left' style='padding-left: 20px; font-size: 5; padding-top: 5px'>Hora Salida:</th>" \
            "       <td colspan='3' class='text-normal' align='left' style='padding-top: 5px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+str(solicitud.horai.strftime("%H:%M"))+"</td>" \
            "       <th colspan='3' scope='colgroup' align='left' style='padding-left: 20px; font-size: 5; padding-top: 5px' >Hora Retorno:</th>" \
            "       <td colspan='3' class='text-normal' align='left' style='padding-top: 5px'>"+str(solicitud.horaf.strftime("%H:%M"))+"</td>" \
            "   </tr>"\
            "   <tr style='font-size: 12px; border: 0px; padding: 0px'>"\
            "       <td width='30%' colspan='4' align='left' ><font size=4><i class='format'></i></br> </br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;______________________</br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Vo.Bo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; RESPONSABLE</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RECURSOS HUMANOS</br>&nbsp;&nbsp;&nbsp;&nbsp;</br>&nbsp;&nbsp;&nbsp;&nbsp;</br></font></td>"\
            "       <td width='30%' colspan='4' align='left' ><font size=4><i class='format'></i></br> </br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;______________________ </br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; TRABAJADOR</br>&nbsp;&nbsp;&nbsp;&nbsp;</br>&nbsp;&nbsp;&nbsp;&nbsp;</br>&nbsp;&nbsp;&nbsp;&nbsp;</br></font></td>"\
