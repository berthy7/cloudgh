...
function attach_edit() {
    ...
    $('.autorizacion').click(function () {
        ...
        ajax_call_get('licencia_autorizacion', {
            _xsrf: getCookie("_xsrf"),
            object: obj
        }, function (response) {
            var self = response;
    ...
    $('.aprobacion').click(function () {
        ...
        ajax_call_get('licencia_aprobacion', {
            _xsrf: getCookie("_xsrf"),
            object: obj
        }, function (response) {
            var self = response;
...
$('#autorizacion').click(function () {
    if (!validationInputSelects("form")) {
        ...
        ajax_call('licencia_autorizacion', {
            object: objeto,
            _xsrf: getCookie("_xsrf")
        }, null, function () {
            setTimeout(function () {
