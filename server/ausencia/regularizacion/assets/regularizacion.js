...
$('#data_table').DataTable({
        ...
        buttons: [
            {  extend : 'excelHtml5',
               exportOptions : { columns : [0, 1, 2, 3, 4, 5 ,6 ,7, 8]},
                sheetName: 'Reporte de Licencias',
        ...
        "initComplete": function(settings, json) {
            /*$('table th:nth-child(7)').removeClass('sorting');
            $('table th:nth-child(9)').removeClass('sorting');*/
        },
        "pageLength": 50
    });
...
$('#insert').click(function () {
    ...
    if (notvalid === false) {
        ...
        ajax_call('regularizacion_insert', {
            object: objeto,
            _xsrf: getCookie("_xsrf")
        }, null, function () {
            setTimeout(function () {
...
function attach_edit() {
    $('.edit').click(function () {
        ...
        ajax_call_get('regularizacion_update', {
            _xsrf: getCookie("_xsrf"),
            object: obj
        }, function (response) {
            var self = response;
    ...
    $('.autorizacion').click(function () {
        ...
        ajax_call_get('regularizacion_autorizacion', {
            _xsrf: getCookie("_xsrf"),
            object: obj
        }, function (response) {
            var self = response;
    ...
    $('.aprobacion').click(function () {
        ...
        ajax_call_get('regularizacion_aprobacion', {
            _xsrf: getCookie("_xsrf"),
            object: obj
        }, function (response) {
            var self = response;
...
$('#update').click(function () {
    ...
    if (notvalid === false) {
        ...
        ajax_call('regularizacion_update', {
            object: objeto,
            _xsrf: getCookie("_xsrf")
        }, null, function () {
            setTimeout(function () {
...
$('#autorizacion').click(function () {
    if (!validationInputSelects("form")) {
        ...
        ajax_call('regularizacion_autorizacion', {
            object: objeto,
            _xsrf: getCookie("_xsrf")
        }, null, function () {
            setTimeout(function () {
...
$('#aprobacion').click(function () {
    if (!validationInputSelects("form")) {
        ...
        ajax_call('regularizacion_aprobacion', {
            object: objeto,
            _xsrf: getCookie("_xsrf")
        }, null, function () {
            setTimeout(function () {
...
$('.delete').click(function (e) {
    ...
    swal({
        ...
        ajax_call('regularizacion_delete', {
            object: objeto,
            _xsrf: getCookie("_xsrf")
        }, null, function () {
            setTimeout(function () {
