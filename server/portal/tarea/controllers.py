...
class PortalTareaController(CrudController):

    manager = PortalTareaManager
    html_index = "portal/tarea/views/index.html"
    html_table = "portal/tarea/views/table.html"
    routes = {
        '/portal_tarea': {'GET': 'index', 'POST': 'table'},
        '/portal_tarea_insert': {'POST': 'insert'},
        '/portal_tarea_update': {'PUT': 'edit', 'POST': 'update'},
        '/portal_tarea_delete': {'POST': 'delete'},
        '/portal_tarea_create': {'POST': 'create'}
    }
