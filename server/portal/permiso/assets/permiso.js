...
$('#insert').click(function () {
    ...
    if (notvalid===false) {
        ...
        if($('#dia_disponibilidad').val() == "Ilimitado"){
            ajax_call('portal_permiso_insert', {
                object: objeto,
                _xsrf: getCookie("_xsrf")
            }, null, function () {
                setTimeout(function () {
            ...
            ajax_call_post("portal_permiso_disponible", {
                _xsrf: getCookie("_xsrf"),
...
function attach_edit() {
    $('.edit').click(function () {
        ...
        ajax_call_get('portal_permiso_update', {
            _xsrf: getCookie("_xsrf"),
            object: obj
        }, function (response) {
            var self = response;
    ...
    $('.autorizacion').click(function () {
        ...
        ajax_call_get('portal_permiso_autorizacion', {
            _xsrf: getCookie("_xsrf"),
            object: obj
        }, function (response) {
            var self = response;
    ...
    $('.aprobacion').click(function () {
        ...
        ajax_call_get('portal_permiso_aprobacion', {
            _xsrf: getCookie("_xsrf"),
            object: obj
        }, function (response) {
            var self = response;
...
$('#update').click(function () {
    ...
    if (notvalid === false) {
        ...
        ajax_call('portal_permiso_update', {
            object: objeto,
            _xsrf: getCookie("_xsrf")
        }, null, function () {
            setTimeout(function () {
...
$('#autorizacion').click(function () {
    if (!validationInputSelects("form")) {
        ...
        ajax_call('portal_permiso_autorizacion', {
            object: objeto,
            _xsrf: getCookie("_xsrf")
        }, null, function () {
            setTimeout(function () {
...
$('#aprobacion').click(function () {
    if (!validationInputSelects("form")) {
        ...
        ajax_call('portal_permiso_aprobacion', {
            object: objeto,
            _xsrf: getCookie("_xsrf")
        }, null, function () {
            setTimeout(function () {
...
//         }).then(function () {
//             ajax_call('portal_permiso_delete', {
//                 id: id,
//                 enabled: enabled,
//                 _xsrf: getCookie("_xsrf")
//             }, null, function () {
